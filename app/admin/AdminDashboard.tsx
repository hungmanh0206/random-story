...
export function AdminDashboard() {
  ...
  if (!authorized) return <main className="admin-access"><img src="/logo-purple-transparent.png" alt="random story." /><h1>Không có quyền truy cập</h1><p>Hãy đăng nhập bằng tài khoản quản trị.</p><Link className="primary-btn" href="/">Về trang chủ</Link></main>;

  return (
    <div className="admin-shell">
      <aside><Link className="brand admin-brand" href="/"><img src="/logo-purple-transparent.png" alt="random story." /></Link><p>Trang quản trị</p><nav><button className="active">Bài viết</button></nav><Link className="admin-exit" href="/">← Xem trang blog</Link></aside>
